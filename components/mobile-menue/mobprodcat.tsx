...
function MobProdcat() {
  return (
    <div className={css.sidmidecategory}>
      {" "}
...
export default MobProdcat;

const DivanBed = () => {
  const [expand, setExpand] = React.useState(false);
  return (
    <>
      <h4 className={css["headingmid"]} onClick={() => setExpand(!expand)}>
        Divan Beds
        <ArrowIcon size={25} />
      </h4>{" "}
      <ul
        className={css["ul-paddmid"]}
        style={{
          overflow: "hidden",
      ...
      >
        <div className={css["subheadingmid"]}>
