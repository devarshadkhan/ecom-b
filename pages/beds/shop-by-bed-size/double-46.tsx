...
import Double46Desc from "../category-descryption/double4ft6-desc";
import Head from "next/head";
import { useRouter } from "next/router";

const Double46: NextPageWithLayout = () => {
  const router = useRouter();
  const { data } = useFetchAllBedsWithSize("4ft-6″-–-double", "beds");
  ...
  return (
    <>
      <NextSEO
        title={
          "Double Bed | 4 Feet 6 inch Double Bed | Beds Divans | Fast Delivery"
        }
        description={
          "Shop for Double (4″6) in the UK at Beds Divans. Add elegance to your home with our wide range of Double (4″6). Order & get fast delivery service!"
        }
      ...
      dangerouslySetInnerHTML={{
        __html:`{
          ...
          "@type": "LocalBusiness",
          "name": "Double Bed | 4 Feet 6 inch Double Bed | Beds Divans|Fast Delivery",
          "image":"https://api1.bedsdivans.co.uk/api/beds-image/red-1673441387518.webp",
        "description": "Shop for Double (4″6) in the UK at Beds Divans. Add elegance to your home with our wide range of Double (4″6). Order & get fast delivery service!",
          "@id": "https://www.bedsdivans.co.uk/",
         "url": "https://bedsdivans.co.uk/beds/shop-by-bed-size/double-46", 
