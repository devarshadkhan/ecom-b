...
import SmallDouble40Desc from "../category-descryption/smalldouble40-desc";
...
const SmallDouble40: NextPageWithLayout = () => {
  ...
  const { data } = useFetchAllBedsWithSize("4ft-–-small-double", "beds");
  ...
  return (
    <>
      <NextSEO
        title={
          "Small Double Bed 4 Feet | Beds Divans | Fast Delivery"
        }
        description={
          "Shop for Small Double (4″0) in the UK at Beds Divans. Add elegance to your home with our wide range of Small Double (4″0). Order & get fast delivery service!"
        }
      ...
      <Head>
        <script
          ...
          "@type": "LocalBusiness",
          "name": "Small Double Bed 4 Feet | Beds Divans | Fast Delivery",
          "image":"https://api1.bedsdivans.co.uk/api/beds-image/red-1673498811844.webp",
        "description": "Shop for Small Double (4″0) in the UK at Beds Divans. Add elegance to your home with our wide range of Small Double (4″0). Order & get fast delivery service!",
          "@id": "https://www.bedsdivans.co.uk/",
         "url": "https://bedsdivans.co.uk/beds/shop-by-bed-size/small-double-40", 
