...
import Single30Desc from "../category-descryption/single3ft-desc";
import Head from "next/head";
import { useRouter } from "next/router";

const Single30: NextPageWithLayout = () => {
  // const [selectedSize, setSelectedSize] = React.useState("3ft");
  const { data } = useFetchAllBedsWithSize("3ft-–-single", "beds");
  const router = useRouter();
  // const { data } = useFetchAllBedsWithImage("3ft");
  ...
  return (
    <>
      <NextSEO
        title={"Single Bed 3 Feet | Beds Divans | Fast Delivery"}
        description={
          "Shop for Single (3″0) in the UK at Beds Divans. Add elegance to your home with our wide range of Single (3″0). Order & get fast delivery service!"
        }
      ...
      <Head>
        <script
          ...
          "@type": "LocalBusiness",
          "name": "Single Bed 3 Feet | Beds Divans | Fast Delivery",
          "image":"https://api1.bedsdivans.co.uk/api/beds-image/red-1673499605946.webp",
        "description": "Shop for Single (3″0) in the UK at Beds Divans. Add elegance to your home with our wide range of Single (3″0). Order & get fast delivery service!",
          "@id": "https://www.bedsdivans.co.uk/",
         "url": "https://bedsdivans.co.uk/beds/shop-by-bed-size/single-30", 
