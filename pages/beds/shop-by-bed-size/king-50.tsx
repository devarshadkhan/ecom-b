...
import King5Desc from "../category-descryption/king5ft-desc";
import Head from "next/head";
import { useRouter } from "next/router";

const King50: NextPageWithLayout = () => {
  const router = useRouter();
  const { data } = useFetchAllBedsWithSize("5ft-–-king", "beds");
  ...
  return (
    <>
      <NextSEO
        title={"King Bed 5 Feet | Beds Divans | Fast Delivery"}
        description={
          "Shop for King (5″0) in the UK at Beds Divans. Add elegance to your home with our wide range of King (5″0). Order & get fast delivery service!"
        }
      ...
      dangerouslySetInnerHTML={{
        __html:`{
          ...
          "@type": "LocalBusiness",
          "name": "King Bed 5 Feet | Beds Divans | Fast Delivery",
          "image":"https://api1.bedsdivans.co.uk/api/beds-image/red-1673436857579.webp",
        "description": "Shop for King (5″0) in the UK at Beds Divans. Add elegance to your home with our wide range of King (5″0). Order & get fast delivery service!",
          "@id": "https://www.bedsdivans.co.uk/",
         "url": "https://bedsdivans.co.uk/beds/shop-by-bed-size/king-50", 
